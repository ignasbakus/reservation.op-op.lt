...
<div
    ...
    <div style="padding: 20px; text-align: center;">
        ...
        <p style="font-size: 16px; margin: 0 0 10px;">Informuojame, kad jūsų užsakymas Nr. <strong>{{$order->order_number}}</strong>
            buvo atšauktas, nes negavome jūsų apmokėjimo.</p>
    </div>
