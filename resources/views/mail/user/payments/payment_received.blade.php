...
<div style="max-width: 600px; margin: 0 auto;">
    ...
    <table role="presentation"
           style="width: 100%; max-width: 650px; margin: 0 auto; background-color: #B6D2F7; padding: 20px; border-collapse: collapse; min-height: 150px">
        <tbody>
        <tr>
            <td style="text-align: center; font-size: 16px; color: black; font-family: 'Open Sans', sans-serif; padding-top: 10px;">
                <a href="{{config('app.link_to_homepage')}}" style="text-decoration: none; color: black;"
                   target="_blank">
                    op-op.lt
                </a>
            </td>
        ...
        <tr>
            <td style="text-align: center; font-size: 18px; color: black; font-weight: 500; font-family: 'Open Sans', sans-serif; padding-top: 10px;">
                <a href="tel:{{config('contactInfo.phone')}}" style="text-decoration: none; color: black;"
                   target="_blank">
                    <svg style="display: block; margin: 0 auto;" width="20" height="20" fill="currentColor"
                         viewBox="0 0 16 16">
                        <path
