...
<div style="max-width: 650px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 5px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    ...
    <div style="padding: 20px; text-align: center;">
        <h1 style="font-size: 24px; margin: 0 0 10px; font-weight: 500;">Užsakymas Patvirtintas</h1>
        <p style="font-size: 15px; margin: 0 0 10px;">Ačiū, kad pateikėte užsakymą!</p>
        <p style="font-size: 15px; margin: 0 0 10px;">Jūsų užsakymo numeris yra <strong>{{$order->order_number}}</strong>.</p>
    </div>
    <div
    ...
    <div style="padding: 20px; text-align: center;">
        <p style="margin-bottom: 10px;"><span style="font-weight: 700;">Svarbi informacija!</span> Jei sumokėjus nuspręsite užsakymą atšaukti,
            <strong>avansas nebus grąžinamas!</strong> Taip pat, prie užsakymo galutinės kainos prisidės <strong>išlaidos už pristatymą</strong>, kurias reikės sumokėti priimant batutą.</p>
    </div>
